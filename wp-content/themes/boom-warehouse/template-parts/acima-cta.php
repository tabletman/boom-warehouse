...
<div class="bm-acima-cta">
    <div class="bm-acima-cta__icon">
    ...
    <div class="bm-acima-cta__text">
        <div>
            As low as <span class="bm-acima-cta__amount">$<?php echo esc_html($monthly); ?>/mo</span> with Acima
        </div>
        <div>
            <a href="<?php echo esc_url(bw_acima_prequalify_url()); ?>"
               class="bm-acima-cta__link"
